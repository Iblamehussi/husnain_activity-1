...
def draw_rectangle(width, height, color):
    ...
    # Draw the first side (width)
    turtle.forward(width)
    turtle.left(90)
    
    # Draw the second side (height)
    turtle.forward(height)
    turtle.left(90)
    
    # Draw the third side (width)
    turtle.forward(width)
    turtle.left(90)
    
    # Draw the fourth side (height)
    turtle.forward(height)
    turtle.left(90)
...
# Function to draw the table with 4 front legs
def draw_table(table_size, table_color):
    ...
    # Draw the front four legs (2 on each side)
    ...
    # Draw additional leg next to the left leg
    turtle.penup()
    turtle.goto(-table_size / 2 + leg_width * 1.5, -table_size / 4 - leg_height)  # Position for second left leg
    turtle.pendown()
    draw_rectangle(leg_width, leg_height, table_color)  # Draw the leg

    # Draw additional leg next to the right leg
    turtle.penup()
    turtle.goto(table_size / 2 - leg_width * 2.5, -table_size / 4 - leg_height)  # Position for second right leg
    turtle.pendown()
    draw_rectangle(leg_width, leg_height, table_color)  # Draw the leg
...
def main():
    ...
    table_size = int(input("Please enter the length of one side of a table (between 10-200): "))
